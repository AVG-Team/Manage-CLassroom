<div class="overflow-hidden">
    <table class="min-w-full divide-y divide-gray-200">
        ...
        @foreach($exercises as $exercise)
            <tr onclick="if (!event.target.closest('.no-navigation')) { location.href='{{ route('admin.exercises.edit', $exercise ->id) }}' }" class="cursor-pointer">
...
{{--                        <a class="hover:text-secondary" href="{{ Storage::url("exercises/" . $exercise->name_file_upload) }}" download>--}}
{{--                            <svg--}}
{{--                                class="fill-current"--}}
{{--                                width="18"--}}
{{--                                height="18"--}}
...
{{--                            </svg>--}}
{{--                        </a>--}}
{{--                        <a class="hover:text-secondary" {{ route('admin.exercises.edit', $exercise->id) }}>--}}
{{--                            <svg--}}
{{--                                class="fill-current"--}}
{{--                                width="18"--}}
{{--                                height="18"--}}
...
{{--                            </svg>--}}
{{--                        </a>--}}
{{--                        <button class="hover:text-secondary btn-delete" data-id="{{ $exercise->id }}">--}}
{{--                            <svg--}}
{{--                                class="fill-current"--}}
{{--                                width="18"--}}
{{--                                height="18"--}}
...
{{--                    </div>--}}
{{--                </td>--}}
                <td class="px-6 py-4 whitespace-nowrap text-end text-sm font-medium no-navigation">
