<div class="overflow-hidden">
    <table class="min-w-full divide-y divide-gray-200">
        ...
        @foreach($exercises as $exercise)
            <tr onclick="location.href='{{ route('admin.exercises.edit', $exercise->id) }}'" class="cursor-pointer">
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800">{{ $exercise->user->name }}</td>
