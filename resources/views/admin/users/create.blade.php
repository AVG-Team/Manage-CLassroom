                            ...
                            <div class="grid sm:grid-cols-2 gap-x-10">
                                <div>
                                    ...
                                    >
                                        ...
                                        >
                                            @foreach(\App\Enums\UserRoleEnum::getArrayViewForStaff() as $role => $roleValue)
                                                <option value="{{ $roleValue }}" class="text-body" {{ old('role') == $roleValue ? "selected" : "" }}>{{ $role }}</option>
                                            @endforeach
                                        </select>
                                        <span
                              ...
                              ></path>
                                ...
                                <div>
                                    ...
                                    <div class="flex gap-x-6 mt-5">
                                        <div class="flex">
                                            <input type="radio" name="gender" {{ old('gender') == 0 ? "checked" : "" }} value="0" id="gender0"
                        ...
                        <div class="mb-4.5">
                            ...
                            <div class="relative flex items-start">
                                <div class="flex items-center h-5 mt-1">
                                    <input id="check_generate_password" name="check_generate_password" value="1" type="checkbox" class="border-gray-200 rounded text-blue-600 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none" checked>
                                </div>
                                <label for="hs-checkbox-delete" class="ms-3">
                                    <span class="block text-sm font-semibold text-gray-800">Tự động tạo mật khẩu</span>
                                    <span id="hs-checkbox-delete-description" class="block text-sm text-gray-600">Mật khẩu sẽ tự tạo ngẫu nhiên và gửi mail về người dùng. ( Khi bạn bỏ tick mật khẩu sẽ là 12345678 )</span>
                                </label>
                            </div>
                        </div>
