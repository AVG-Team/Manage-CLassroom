<x-admin.layouts.app>
    ...
    @section('breadcrumbs')
        {{ Breadcrumbs::render('admin.salaries.create') }}
    @endsection
    <div>
                    ...
                    <div class="p-6.5">
                        ...
                        <div class="mb-4.5 grid sm:grid-cols-2 gap-x-10">
                                    ...
                                    >
                                        @foreach($listDefaultSalary as $defaultSalary)
                                            <option value="{{ $defaultSalary->id }}"
                                                    class="text-body" {{ old('default_salary_id') == $defaultSalary->id ? "selected" : "" }}>{{ $defaultSalary->salary }}</option>
                                        @endforeach
                                    </select>
                                    <span
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="text" id="bonus" name="bonus" value="{{ old('bonus') }}"
                                ...
                                >
                                    ...
                                    >
                                        @foreach(\App\Enums\SalaryStatusEnum::getArrayView() as $key => $value)
                                            <option value="{{ $value }}"
                                                    class="text-body" {{ old('status') == $value ? "selected" : "" }}>{{ $key }}</option>
                                        @endforeach
                                    </select>
                                    <span
                                        class="absolute right-4 top-1/2 z-10 -translate-y-1/2"
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input id="datepicker" name="payday" value="{{ old('payday') }}"
                                               type="text"
                        ...
                        <x-user.form.buttons.primary type="submit"
                                                     class="w-full justify-center font-medium p-3 rounded">Thêm Lương Cho Giảng Viên
