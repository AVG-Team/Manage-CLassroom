...
<div id="docs-sidebar" class="z-99 hs-overlay [--auto-close:lg] hs-overlay-open:translate-x-0 -translate-x-full transition-all duration-300 transform hidden fixed top-0 start-0 bottom-0 z-[60] w-64 bg-white border-e border-gray-200 pt-7 pb-10 overflow-y-auto lg:block lg:translate-x-0 lg:end-auto lg:bottom-0 [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 lg:static ">
    ...
    <nav class="hs-accordion-group p-6 w-full flex flex-col flex-wrap">
        <ul class="space-y-1.5">
            ...
            <li class="hs-accordion {{ Request::routeIs('admin.classrooms.*') || Request::routeIs('admin.exercises.*') ? 'active' : '' }}" id="class-manage">
                ...
                <div id="class-manage" class="hs-accordion-content w-full overflow-hidden transition-[height] duration-300 {{ Request::routeIs('admin.classrooms.*') || Request::routeIs('admin.exercises.*') ? '' : 'hidden' }}">
                    <ul class="pt-2 ps-2">
                        ...
                        <li>
                            <a class="hs-accordion-toggle hs-accordion-active:text-secondary hs-accordion-active:hover:bg-transparent hs-accordion-active:font-medium flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-gray-700 rounded-lg hover:bg-gray-200" href="#">
