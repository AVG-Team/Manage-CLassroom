...
<div id="docs-sidebar" class="z-99 hs-overlay [--auto-close:lg] hs-overlay-open:translate-x-0 -translate-x-full transition-all duration-300 transform hidden fixed top-0 start-0 bottom-0 z-[60] w-64 bg-white border-e border-gray-200 pt-7 pb-10 overflow-y-auto lg:block lg:translate-x-0 lg:end-auto lg:bottom-0 [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 lg:static ">
    ...
    <nav class="hs-accordion-group p-6 w-full flex flex-col flex-wrap">
        <ul class="space-y-1.5">
            <li>
                <a class="flex items-center gap-x-3.5 py-2 px-2.5 bg-gray-100 text-sm text-gray-700 rounded-lg hover:bg-gray-100" href="{{ route("admin.home") }}">
            ...
            <li class="hs-accordion">
                ...
                <div class="hs-accordion-content w-full overflow-hidden transition-[height] duration-300 hidden">
                    <ul class="hs-accordion-group ps-3 pt-2">
                        <li class="hs-accordion">
                            <a class="flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-gray-700 rounded-lg hover:bg-gray-100" href="{{ route("admin.users.index") }}">
                                Quản Lý Tất Cả
                            </a>
                        </li>
                        <li class="hs-accordion">
                            <a href="{{ route("admin.users.index") . "?filter_type=0" }}" class="hs-accordion-toggle hs-accordion-active:text-blue-600 hs-accordion-active:hover:bg-transparent w-full text-start flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-gray-700 rounded-lg hover:bg-gray-100">
                                <p>Quản Lý Học Sinh</p>
                            </a>
                        </li>
                        <li class="hs-accordion">
                            <a href="{{ route("admin.users.index") . "?filter_type=1" }}" class="hs-accordion-toggle hs-accordion-active:text-blue-600 hs-accordion-active:hover:bg-transparent w-full text-start flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-gray-700 rounded-lg hover:bg-gray-100">
                                <p>Quản Lý Giáo Viên</p>
                            </a>
                        </li>
                        @if(auth()->user()->key_role == \App\Enums\UserRoleEnum::ADMIN)
                            <li class="hs-accordion">
                                <a href="{{ route("admin.users.index") . "?filter_type=2" }}" class="hs-accordion-toggle hs-accordion-active:text-blue-600 hs-accordion-active:hover:bg-transparent w-full text-start flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-gray-700 rounded-lg hover:bg-gray-100">
            ...
            <li class="hs-accordion" id="class-manage">
                <button type="button" class="hs-accordion-toggle hs-accordion-active:text-blue-600 hs-accordion-active:hover:bg-transparent w-full text-start flex items-center py-2 text-sm text-gray-700 rounded-lg hover:bg-gray-100">
                ...
                <div id="class-manage" class="hs-accordion-content w-full overflow-hidden transition-[height] duration-300 hidden">
                    <ul class="pt-2 ps-2">
                        <li>
            ...
            <li>
                <a href="" class="hs-accordion-active:text-blue-600 hs-accordion-active:hover:bg-transparent w-full text-start flex items-center py-2 text-sm text-gray-700 rounded-lg hover:bg-gray-100">
            ...
            <li><a class="flex items-center py-2 text-sm text-gray-700 rounded-lg hover:bg-gray-100" href="#">
                    <svg class="size-5 ml-2 mr-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
