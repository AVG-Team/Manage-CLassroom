<div class="h-auto mb-2 border rounded-xl ">
    <div class="p-4 bg-white rounded-lg shadow-md">
        <div class="flex items-center">
            ...
            <div class="ml-4">
                <div class="font-bold text-md">Nguyễn Thanh Tùng</div>
                <div class="text-xs text-gray-600 ">3 tháng 6</div>
            </div>
        </div>
        <div class="pb-4 mt-3 border-b">
            <p>Mai mang đủ máy đi làm bài kt nhé ;) Nội dung crud giao diện có quan hệ 2 bảng</p>
        </div>
