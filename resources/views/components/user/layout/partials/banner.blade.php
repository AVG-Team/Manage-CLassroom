<section id="hero" class="w-full">
    <div class="relative grid max-w-screen-xl grid-cols-12 px-4 mx-auto overflow-hidden sm:px-8 gap-x-6" v-bind="$attrs">
        ...
        <img
            data-aos="fade-up"
            data-aos-delay="300"
            src="{{ asset('storage/img/pattern/ellipse-1.png') }}"
            alt="Ellipse 1"
        ...
        <img
          ...
          data-aos="fade-up"
          data-aos-delay="300"
          src="{{ asset('storage/img/pattern/ellipse-2.png') }}"
        ...
        <img
          ...
          data-aos="fade-up"
          data-aos-delay="300"
          src="{{ asset('storage/img/pattern/ellipse-3.png') }}"
        ...
        <img
            ...
            data-aos="fade-up"
            data-aos-delay="300"
            src="{{ asset('storage/img/pattern/star.png') }}"
